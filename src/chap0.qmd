...
| Dataset | Domain | Subjects | Items | Conditions | Outcome | Source |
|---------|--------|----------|-------|------------|---------|--------|
| Collab-CXR | Radiology | 336 radiologists | 324 CXR cases | 4 (image only, +history, +AI, +AI+history) | Diagnostic probability | [OSF](https://osf.io/z7apq/) |
| METR Early-2025 | Coding | 16 developers | 246 issues | {AI allowed, AI disallowed} | Completion time (min) | [GitHub](https://github.com/METR/Measuring-Early-2025-AI-on-Exp-OSS-Devs) |
| METR Late-2025 | Coding | 57 developers | 1,134 issues | {AI allowed, AI disallowed} | Completion time (min) | [GitHub](https://github.com/METR/Measuring-Late-2025-AI-on-OSS-Devs) |
| HAIID | Classification | 1,125 participants | 152 items (5 domains) | Pre/post advice x {AI, human label} | Binary correct | [GitHub](https://github.com/kailas-v/human-ai-interactions) |
| GenAI Learning | Education (math) | 943 students | 57 practice + 48 exam | {control, vanilla GPT, augmented GPT} | Binary score | [GitHub](https://github.com/obastani/GenAICanHarmLearning) |
:::

**Collab-CXR** [@yu2024collabcxr] is the largest and cleanest dataset. 227 radiologists each read a subset of 324 chest X-ray cases under four conditions (with/without AI predictions, with/without clinical history), providing probabilistic assessments for 104 pathologies per case. The within-subject, crossed design makes it ideal for many-facet analysis. AI assistance improves mean diagnostic accuracy from 96.5% to 97.1%, but the effect is heterogeneous across radiologists and pathologies.

**METR Developer Productivity** [@metr2025productivity] is a within-subject RCT where each developer's issues are randomly assigned to AI-allowed or AI-disallowed conditions. The early study (16 developers, 246 tasks) found that AI-allowed tasks took *longer* (119.5 vs. 90.9 minutes) --- a counterintuitive result driven by context-switching costs and AI-induced scope expansion. The late study (57 developers, 1,134 tasks) found a smaller and reversed effect (151 vs. 169 minutes), though with severe selection effects. A key limitation for IRT analysis: items are developer-specific (not shared across subjects), producing a block-diagonal matrix.
