...
**HAIID** [@vodrahalli2022haiid] measures whether labeling advice as "from AI" versus "from a human" changes how people use it. Across five classification domains (art, census, cities, sarcasm, dermatology), the label has minimal effect: AI-labeled advice improves accuracy by +5--9%, and human-labeled advice improves accuracy by nearly the same amount. The advice *content*, not its provenance, drives the effect.
