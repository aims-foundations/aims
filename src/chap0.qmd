...
**Safety and security.** Benchmarks like CyBench (CTF challenges), AgentDojo (security evaluation of tool-using agents with 949 security items), and the red-teaming frameworks discussed in @sec-redteaming test adversarial robustness and safety properties. These benchmarks are distinctive because the "correct" response is often a refusal, and the construct (safety) is inherently adversarial.
...
The following tables enumerate all 70 benchmarks curated in the `torch_measure` collection, organized by domain and sorted by release date. Together they span over 1.2 million unique evaluation items and over 6,700 model/agent entries, with 55 benchmarks providing full per-item response matrices.
...
| # | Benchmark | $N \times M$ | Type | Evaluation Method | Released | Reference |
|:--|-----------|:---:|:---:|-------------------|:---:|-----------|
| 39 | IgakuQA | 5 × 1,471 | Bin | MCQ; Japanese medical licensing exams (2018--2022) | 2023-03 | [jungokasai/IgakuQA](https://github.com/jungokasai/IgakuQA) |
| 40 | LawBench | 51 × 9,000 | Bin | Exact match; 20 Chinese legal tasks, zero-shot | 2023-09 | [open-compass/LawBench](https://github.com/open-compass/LawBench) |
| 41 | FinanceBench | 16 × 150 | Bin | Expert-graded; SEC filing QA | 2023-11 | [patronus-ai/financebench](https://github.com/patronus-ai/financebench) |
| 42 | LexEval | 38 × 14,147 | Con | Rubric; 23 Chinese legal tasks (NeurIPS 2024) | 2024-09 | [CSHaitao/LexEval](https://github.com/CSHaitao/LexEval) |
| 43 | AfriMedQA | 30 × 6,910 | Bin | MCQ; Pan-African medical, 20 specialties | 2024-09 | [arXiv:2409.15290](https://arxiv.org/abs/2409.15290) |

**Preference and Reward Modeling**

| # | Benchmark | $N \times M$ | Type | Evaluation Method | Released | Reference |
|:--|-----------|:---:|:---:|-------------------|:---:|-----------|
| 44 | AlpacaEval | 221 × 805 | Bin | LLM judge; win/loss vs GPT-4 | 2023-05 | [tatsu-lab/alpaca_eval](https://github.com/tatsu-lab/alpaca_eval) |
| 45 | MT-Bench | — × 80 | — | GPT-4 + human pairwise; multi-turn | 2023-06 | [lm-sys/FastChat](https://github.com/lm-sys/FastChat) |
| 46 | UltraFeedback | 17 × 63,966 | Con | GPT-4 judge; overall score (1--10) | 2023-10 | [OpenBMB/UltraFeedback](https://github.com/OpenBMB/UltraFeedback) |
| 47 | RewardBench | 149 × 2,985 | Bin | Score comparison; chosen vs rejected | 2024-03 | [arXiv:2403.13787](https://arxiv.org/abs/2403.13787) |
| 48 | WildBench | 63 × 1,024 | Con | LLM judge; checklist scoring | 2024-06 | [arXiv:2406.04770](https://arxiv.org/abs/2406.04770) |

**Multilingual and Cultural Evaluation**

| # | Benchmark | $N \times M$ | Type | Evaluation Method | Released | Reference |
|:--|-----------|:---:|:---:|-------------------|:---:|-----------|
| 49 | MasakhaNER v2 | — × — | Bin | NER; 20 African languages | 2022-10 | [arXiv:2210.12391](https://arxiv.org/abs/2210.12391) |
| 50 | HELM African | — × — | Con | HELM harness; African language tasks | 2022-11 | [HELM](https://crfm.stanford.edu/helm/) |
| 51 | HELM CLEVA | — × — | Con | HELM harness; Chinese language eval | 2022-11 | [HELM](https://crfm.stanford.edu/helm/) |
| 52 | HELM ThaiExam | — × — | Con | HELM harness; Thai examination tasks | 2022-11 | [HELM](https://crfm.stanford.edu/helm/) |
| 53 | C-Eval | — × 12,342 | Bin | MCQ; Chinese educational system | 2023-05 | [arXiv:2305.08322](https://arxiv.org/abs/2305.08322) |
| 54 | CMMLU | — × 11,582 | Bin | MCQ; Chinese 67 subjects | 2023-06 | [arXiv:2306.09212](https://arxiv.org/abs/2306.09212) |
| 55 | Rakuda | 141 × 40 | Con | LLM judge; Japanese open-ended QA | 2023-06 | [shisa-ai/shaberi](https://github.com/shisa-ai/shaberi) |
| 56 | SIB-200 | 2 × 41,820 | Bin | Classification; 205 languages | 2023-09 | [arXiv:2309.07445](https://arxiv.org/abs/2309.07445) |
| 57 | OALL Arabic MMLU | — × — | Bin | MCQ; native Arabic knowledge questions | 2024-02 | [OALL](https://huggingface.co/blog/leaderboard-arabic-v2) |
| 58 | OALL Arabic Exams | — × — | Bin | MCQ; Arabic exam questions | 2024-02 | [OALL](https://huggingface.co/blog/leaderboard-arabic-v2) |
| 59 | KMMLU | — × 35,030 | Bin | MCQ; Korean exams | 2024-02 | [arXiv:2402.11548](https://arxiv.org/abs/2402.11548) |
| 60 | Tengu-Bench | 141 × 120 | Con | LLM judge; Japanese multi-category | 2024-04 | [shisa-ai/shaberi](https://github.com/shisa-ai/shaberi) |
| 61 | AfriEval | — × 469,210 | Bin | MCQ + NLI + QA; African languages | 2024 | HuggingFace |
| 62 | AsiaEval | — × 398,263 | Bin | MCQ + NLI; Asian languages | 2024 | HuggingFace |
| 63 | CulturalEval | — × 82,996 | Bin | MCQ; cross-cultural values | 2024 | HuggingFace |
| 64 | IberBench | — × 32,797 | Bin | MCQ + NLI; Iberian languages | 2024 | HuggingFace |
| 65 | Bridging Gap | 1,767 × 36 | Bin | MCQ; Winogrande × 12 languages | 2024 | HuggingFace |
| 66 | Ko Leaderboard | 1,159 × 9 | Con | lm-eval-harness; Korean tasks | 2024 | [Open Ko-LLM](https://huggingface.co/spaces/upstage/open-ko-llm-leaderboard) |
| 67 | La Leaderboard | 69 × 108 | Con | lm-eval-harness; Iberian tasks | 2024 | HuggingFace |
| 68 | PT Leaderboard | 1,148 × 10 | Con | lm-eval-harness; Portuguese | 2024 | HuggingFace |
| 69 | Thai Leaderboard | 72 × 19 | Con | lm-eval-harness; Thai tasks | 2024 | HuggingFace |
| 70 | TUMLU | 30 × 7,486 | Bin | MCQ; 9 Turkic languages, CoT + non-CoT | 2024-12 | [ceferisbarov/TUMLU](https://github.com/ceferisbarov/TUMLU) |
...
## Beyond Benchmarks: Intervention Data {#sec-intervention-data}

The data landscape above measures AI systems directly: present items to models and record responses. But a growing body of AI evaluation asks a different question: *what happens when humans use AI?* Red teaming, deployment RCTs, uplift studies, and human-AI collaboration experiments all produce structured data that complements the benchmark paradigm.
...
the **intervention matrix** records:
...
### An Inventory of Intervention Data {#sec-intervention-inventory}
...
## Intervention Dataset Inventory
...
![Per-developer treatment effect in the METR Early-2025 study. Each bar shows the difference in mean completion time (AI-allowed minus AI-disallowed) for one developer. Blue bars indicate developers who were *slower* with AI assistance; red bars indicate developers who were faster. The mean treatment effect is +35.6 minutes (AI slows developers down), but with substantial heterogeneity: developer 755 was 250 minutes slower with AI, while developer 229 was 120 minutes faster.](Figures/intervention/metr_early_subject_effect.png){#fig-metr-effect width="85%"}
...
![HAIID accuracy across five classification domains, before and after receiving advice. Gray bars show pre-advice accuracy. Blue and red bars show post-advice accuracy when the advice was labeled as coming from AI or a human, respectively. The near-identical heights of blue and red bars demonstrate that the advice source label has minimal effect on human behavior.](Figures/intervention/haiid_summary.png){#fig-haiid-summary width="90%"}
...
![The GenAI Learning paradox. During practice (blue bars), AI-assisted students dramatically outperform controls: GPT Tutor students score 0.692 vs. 0.335 for controls. But on a subsequent exam without AI (red bars), the effect vanishes or reverses: GPT Tutor students score 0.357 vs. 0.362 for controls. GPT Base students actually score *worse* than controls on the exam (0.293). The AI inflated apparent performance without producing durable learning.](Figures/intervention/genai_practice_vs_exam.png){#fig-genai-paradox width="70%"}

### What Intervention Data Enables
