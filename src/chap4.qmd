...
$$\beta_{j2} \sim \text{LogNormal}(0, 0.5) \text{ or } \beta_{j2} \sim \text{Gamma}(2, 0.5)$$
...
### Hierarchical Priors and Partial Pooling {#sec-hierarchical-models}
